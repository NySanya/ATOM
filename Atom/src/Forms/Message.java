...
public class Message extends JPanel {
    ...
    public Message(int type) {
        ...
        if(type == 0) {
            messageText.setBackground(new Color(0,169,213));
        } else if(type == 1) {
            messageText.setBackground(new Color(70,73,162));
        }
       ...
       /* messageText.setLineWrap(true);
        ...
        datePane.setPreferredSize(new Dimension(getWidth(),35));
        ...
        dateText.setForeground(new Color(130,130,130));
        datePane.add(dateText);
    }



    public static Message messageIn(String text, String date) {
    ...
    public static Message messageOut(String text, String date) {
        ...
        message.setMaximumSize(new Dimension(Short.MAX_VALUE,message.getHeight()));
        return message;
    }
}
